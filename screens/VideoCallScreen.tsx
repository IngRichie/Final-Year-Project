...
const VideoCallScreen: React.FC<VideoCallScreenProps> = ({ route }) => {
  ...
  const { counselor, callDuration, userImage } = route.params;
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <View style={styles.header}>
          ...
          <View style={styles.headerTextContainer}>
            ...
            <Text style={styles.subHeaderText}>{callDuration}</Text>
          </View>
        ...
        <Image
          ...
          source={{ uri: userImage }} // Use the user image from the passed params
        />

    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <View style={styles.BtnSection}>
          ...
          <Pressable style={[styles.button, { width: responsiveWidth(90) }]} onPress={() => handlePress("Medical Emergency")}>
            <FontAwesome5 name="medkit" size={24} color="#1F75FE" style={styles.buttonIcon} />
            <Text style={styles.buttonText}>Medical Emergency</Text>
          </Pressable>
          <Pressable style={[styles.button, { width: responsiveWidth(90) }]} onPress={() => handlePress("Fire Emergency")}>
          ...
          <Pressable style={[styles.button, { width: responsiveWidth(90) }]} onPress={() => handlePress("Personal Safety")}>
          ...
          <Pressable style={[styles.button, { width: responsiveWidth(90) }]} onPress={() => handlePress("Domestic Accident")}>
